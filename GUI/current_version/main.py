...
Description: config.yaml (modified) + gas_chromatography.py + gc_class.py + gc_gui.py. Will be compiled to exe or bin
Usage: Call as main.
Version:
1.0 - 27 April 2020 - Initial Creation. Copy paste and removal of redundancies.
'''
...
class MainApp(GCFrame):
    def __init__(self, parent):
        ...
        _dict = {'BODY_FONT_SIZE': 11,
        'HEADER_FONT_SIZE': 18,
        'EXTRA_SPACE': 10,
        'BORDER': 10,

        'DEFAULT_FRAME_SIZE': (1000,500),
        'DEFAULT_SASH_SIZE': 250,
